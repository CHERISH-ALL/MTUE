...
require('../_chunks/dep-91825110.js');
require('@babel/runtime/helpers/typeof');
require('../_chunks/dep-bda56502.js');
require('dayjs');
...
var _RangeInput = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var isShowClearIcon = Vue.computed(function () {
      ...
      return (props2.clearable && ((_inputValue$value = inputValue.value) === null || _inputValue$value === void 0 ? void 0 : _inputValue$value.length) && !disabled.value || props2.showClearIconOnEmpty) && isHover.value;
    });
    var inputRefs = {
    ...
    return function () {
      ...
      var RangeInputContent = Vue.createVNode("div", Vue.mergeProps(attrs, {
        "class": [COMPONENT_NAME.value, _defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"]({}, SIZE.value[props2.size], props2.size !== "medium"), STATUS.value.disabled, disabled.value), STATUS.value.focused, focused.value), STATUS.value.success, props2.status === "success"), STATUS.value.warning, props2.status === "warning"), STATUS.value.error, props2.status === "error"), "".concat(COMPONENT_NAME.value, "--prefix"), prefixIconContent || labelContent), "".concat(COMPONENT_NAME.value, "--suffix"), suffixContent || suffixIconContent), "".concat(COMPONENT_NAME.value, "--borderless"), props2.borderless)],
