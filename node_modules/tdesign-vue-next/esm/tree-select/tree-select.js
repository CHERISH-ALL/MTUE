  ...
  setup: function setup(props2, _ref) {
    ...
    var treeNodeChange = function treeNodeChange(valueParam, context) {
      ...
      if (isObjectValue.value) {
        current = valueParam.map(function (nodeValue) {
          return _getTreeNode(props2.data, nodeValue);
        });
      }
    ...
    var treeNodeActive = function treeNodeActive(valueParam, context) {
      ...
      if (isObjectValue.value) {
        ...
        current = _getTreeNode(props2.data, nodeValue);
      } else {
    ...
    var getSingleNodeInfo = function getSingleNodeInfo() {
      ...
      var node = _getTreeNode(props2.data, nodeValue);
      if (!node) {
        return {
          label: nodeValue,
          value: nodeValue
    ...
    var _getTreeNode = function getTreeNode(data, targetValue) {
      for (var i = 0, len = data.length; i < len; i++) {
        ...
        if (data[i][realValue.value] === targetValue) {
          return _objectSpread(_objectSpread({}, data[i]), {}, {
        ...
        if ((_data$i = data[i]) !== null && _data$i !== void 0 && _data$i[realChildren.value]) {
          var _data$i2;
          var result = _getTreeNode((_data$i2 = data[i]) === null || _data$i2 === void 0 ? void 0 : _data$i2[realChildren.value], targetValue);
          if (!isNil(result)) {
            return result;
          }
        }
