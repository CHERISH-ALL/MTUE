...
import '../_chunks/dep-ded70abd.js';
import '../_chunks/dep-8f8d7376.js';
import 'dayjs';
import '../_chunks/dep-07afdb3f.js';
  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      var RangeInputContent = createVNode("div", mergeProps(attrs, {
        "class": [COMPONENT_NAME.value, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, SIZE.value[props2.size], props2.size !== "medium"), STATUS.value.disabled, disabled.value), STATUS.value.focused, focused.value), STATUS.value.success, props2.status === "success"), STATUS.value.warning, props2.status === "warning"), STATUS.value.error, props2.status === "error"), "".concat(COMPONENT_NAME.value, "--prefix"), prefixIconContent || labelContent), "".concat(COMPONENT_NAME.value, "--suffix"), suffixContent || suffixIconContent), "".concat(COMPONENT_NAME.value, "--borderless"), props2.borderless)],
