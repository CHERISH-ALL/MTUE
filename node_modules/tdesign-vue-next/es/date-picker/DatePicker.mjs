...
import { g as getDefaultFormat, f as formatDate, p as parseToDayjs, c as covertToDate, a as formatTime, s as subtractMonth, b as addMonth, e as extractTimeObj } from '../_chunks/dep-7f0a43d9.mjs';
...
import { _ as _baseGetTag } from '../_chunks/dep-19284555.mjs';
import { i as isObjectLike_1 } from '../_chunks/dep-5b72198e.mjs';
import { _ as _baseUnary } from '../_chunks/dep-8eb27cbe.mjs';
import { _ as _nodeUtil } from '../_chunks/dep-564c533a.mjs';
...
var _DatePicker = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    watch(popupVisible, function (visible) {
      ...
      var dateValue = value.value && !isDate_1(value.value) && !["week", "quarter"].includes(props2.mode) ? covertToDate(value.value, (_formatRef$value = formatRef.value) === null || _formatRef$value === void 0 ? void 0 : _formatRef$value.valueType) : value.value;
